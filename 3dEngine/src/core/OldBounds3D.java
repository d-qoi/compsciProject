...
public class OldBounds3D {

	public int x, y, z, width, height, depth;

	public OldBounds3D(int x, int y, int z, int width, int depth, int height) {
		this.x = x;
		this.y = y;
		this.z = z;
		this.width = width;
	...
	public OldBounds3D(Rectangle base, int z, int height) {
	...
	public boolean intersects(OldBounds3D other) {
